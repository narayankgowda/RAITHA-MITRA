...
export const LeafIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M11 20A7 7 0 0 1 4 13H2a10 10 0 0 0 10 10zM2 11h2a7 7 0 0 1 7-7V2a10 10 0 0 0-9 9z"></path><path d="M13 4a7 7 0 0 1 7 7h2a10 10 0 0 0-9-9z"></path></svg>
);
...
export const SparklesIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 2L9.8 8.2 4 10l6.2 5.8L8.2 22 12 18l3.8 4L14.2 15.8 20 10l-5.8-1.8z"></path></svg>
);
...
export const FlaskConicalIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M8.5 2h7L21 13v7H3v-7l5.5-11zM6 13h12"></path></svg>
);
...
export const PawPrintIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="12" r="4"></circle><circle cx="5" cy="8" r="1.5"></circle><circle cx="19" cy="8" r="1.5"></circle><circle cx="8" cy="4" r="1.5"></circle><circle cx="16" cy="4" r="1.5"></circle></svg>
);

export const BotIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect x="2" y="7" width="20" height="14" rx="2" ry="2"></rect><path d="M16 2v4M8 2v4"></path><path d="M12 13v0"></path></svg>
);
...
export const WindIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M9.59 4.59A2 2 0 1 1 11 8H2m10.59 11.41A2 2 0 1 0 14 16H2m15.73-8.27A2.5 2.5 0 1 1 19.5 12H2"></path></svg>
);

export const SunriseIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 2v8"></path><path d="m4.93 10.93 1.41 1.41"></path><path d="M2 18h20"></path><path d="M17.66 7.66 12 13.31 6.34 7.66"></path></svg>
);

export const DropletsIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M7 16.3c2.2 0 4-1.83 4-4.05 0-1.16-.49-2.2-1.25-3.02C9.02 8.45 8.01 8 7 8s-2.02.45-2.75 1.23C3.5 10.03 3 11.1 3 12.25c0 2.22 1.8 4.05 4 4.05zM12.56 6.6A10.97 10.97 0 0 0 14 3.02c.52 1.24 1.22 2.4 2.14 3.46.92 1.05 2.06 1.94 3.3 2.5a12.22 12.22 0 0 1-1.84 4.36c.42.1.84.21 1.27.31-.41 1.05-.9 2.07-1.46 3.05a11.48 11.48 0 0 1-5.11 4.5c-1.24.4-2.52.54-3.8.44a10.25 10.25 0 0 1-3.6-1.05c-1.34-.82-2.5-1.88-3.43-3.1C2.39 15.1 2 13.7 2 12.25c0-1.52.54-2.95 1.48-4.14.94-1.2 2.24-2.18 3.73-2.82A11.5 11.5 0 0 1 11.2 3c.33.5.64 1.03.94 1.56.3.53.58 1.08.84 1.64.26.56.5 1.13.72 1.71a10.84 10.84 0 0 1-1.18-1.3z"></path></svg>
);
...
export const CloudRainIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M20 16.2A4.5 4.5 0 0 0 17.5 10h-1.8A7 7 0 1 0 9 16.6"></path><path d="M16 14v2"></path><path d="M8 14v2"></path><path d="M12 16v2"></path></svg>
);

export const CloudLightningIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M20 16.2A4.5 4.5 0 0 0 17.5 10h-1.8A7 7 0 1 0 9 16.6"></path><path d="M13 11l-4 6h6l-4 6"></path></svg>
);

export const CloudDrizzleIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M8 19v-1.5a2.5 2.5 0 0 1 5 0V19"></path><path d="M16 19v-1.5a2.5 2.5 0 0 0-5 0V19"></path><path d="M12 21v1"></path><path d="M20 16.2A4.5 4.5 0 0 0 17.5 10h-1.8A7 7 0 1 0 9 16.6"></path></svg>
);
...
export const CloudFogIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M20 17.58A5 5 0 0 0 18 8h-1.26A8 8 0 1 0 4 16.25"></path><path d="M5 22h14"></path><path d="M5 18h14"></path></svg>
);
...
export const TractorIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M3 15h1a2 2 0 0 0 2-2V9.5A2.5 2.5 0 0 0 3.5 7H3m11 8h5a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2h-1"></path><path d="M6 15H4a2 2 0 0 0-2 2v2h4v-3a1 1 0 0 0-1-1zm14 0h-4a1 1 0 0 0-1 1v3h4v-2a2 2 0 0 0-2-2z"></path><path d="M6 9H4.5A2.5 2.5 0 0 1 2 6.5V6H1m18 0h-1.5a2.5 2.5 0 0 0-2.5 2.5V9h-3"></path><path d="M8 9h1a3 3 0 0 1 3 3v3h1"></path></svg>
);
